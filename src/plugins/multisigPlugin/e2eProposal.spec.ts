...
test('Multisig Plugin Test - Publish, Approve, and Execute Proposal', async ({ page, metamask }) => {
    ...
    await page.getByLabel('Recipient').fill('0x9ef1877684605b94c8c1fee6b7c2de0c9e0c6a27');
