...
test('Token Plugin Test - Publish, Approve, and Execute Proposal', async ({ page, metamask }) => {
    ...
    await page.getByLabel('Recipient').fill('0xe29a587359a0c055a66ae3562632436bd8e6e9a0');
